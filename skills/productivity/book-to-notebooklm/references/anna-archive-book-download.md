# Archived skill: anna-archive-book-download

Original path: `anna-archive-book-download/SKILL.md`
...
| curl to CDN IP URL (e.g. `93.123.118.12:6060/...`) returns 403 | **Normal behavior.** These CDN URLs only work in a browser context. Use the browser slow-download flow instead. Do NOT waste time trying different curl User-Agent strings. |
